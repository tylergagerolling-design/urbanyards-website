...
test("archived workspace polish remains available with current dashboard assets", () => {
  ...
  assert.match(html, /dashboard\.css\?v=20260908-design-polish-1/);
  assert.match(html, /dashboard\.js\?v=20260908-design-polish-1/);
});
...
test("Tickets Leads and Money use the same flat white page canvas as Home and Work", () => {
  ...
  assert.match(html, /dashboard-unified\.css\?v=20260908-design-polish-1/);
