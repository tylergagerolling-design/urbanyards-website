...
const TABLE_PERMISSIONS = {
  ...
  vendors: { GET: "money:read", POST: "money:write", PATCH: "money:write", DELETE: "admin:manage" },
  expenses: { GET: "money:read", POST: "money:write", PATCH: "money:write", DELETE: "admin:manage" },
  expense_attachments: { GET: "money:read", POST: "money:write", PATCH: "money:write", DELETE: "admin:manage" },
  invoice_line_items: { GET: "money:read", POST: "money:write", PATCH: "money:write", DELETE: "admin:manage" },
  invoice_payments: { GET: "money:read", POST: "money:write", PATCH: "money:write", DELETE: "admin:manage" },
  invoice_attachments: { GET: "money:read", POST: "money:write", PATCH: "money:write", DELETE: "admin:manage" },
  financial_documents: { GET: "money:read", POST: "money:write", PATCH: "money:write", DELETE: "admin:manage" },
  financial_activity: { GET: "money:read", POST: "money:write", PATCH: "admin:manage", DELETE: "admin:manage" },
  financial_import_batches: { GET: "money:read", POST: "money:write", PATCH: "money:write", DELETE: "admin:manage" },
  financial_import_batch_rows: { GET: "money:read", POST: "money:write", PATCH: "money:write", DELETE: "admin:manage" },
  ...
  job_ticket_crew_assignments: { GET: "operations:read", POST: "operations:write", PATCH: "operations:write", DELETE: "admin:manage" },
  job_ticket_equipment_assignments: { GET: "operations:read", POST: "operations:write", PATCH: "operations:write", DELETE: "admin:manage" },
...
const FEATURE_BY_TABLE = {
  ...
  job_ticket_crew_assignments: "connected_operations_enabled",
  job_ticket_equipment_assignments: "connected_operations_enabled",
