...
const ROLE_PERMISSIONS = {
  ...
  manager: [
    ...
    "budgets:read", "budgets:write", "budgets:archive",
...
const TABLE_PERMISSIONS = {
  ...
  budget_settings: { GET: "budgets:read", POST: "admin:manage", PATCH: "admin:manage", DELETE: "admin:manage" },
  job_budgets: { GET: "budgets:read", POST: "budgets:write", PATCH: "budgets:write", DELETE: "budgets:archive" },
  job_budget_labor: { GET: "budgets:read", POST: "budgets:write", PATCH: "budgets:write", DELETE: "budgets:archive" },
  job_budget_materials: { GET: "budgets:read", POST: "budgets:write", PATCH: "budgets:write", DELETE: "budgets:archive" },
  budget_material_catalog: { GET: "budgets:read", POST: "budgets:write", PATCH: "budgets:write", DELETE: "budgets:archive" },
  job_budget_equipment: { GET: "budgets:read", POST: "budgets:write", PATCH: "budgets:write", DELETE: "budgets:archive" },
  job_budget_costs: { GET: "budgets:read", POST: "budgets:write", PATCH: "budgets:write", DELETE: "budgets:archive" },
  job_budget_change_orders: { GET: "budgets:read", POST: "budgets:write", PATCH: "budgets:write", DELETE: "budgets:archive" },
  job_budget_documents: { GET: "budgets:read", POST: "budgets:write", PATCH: "budgets:write", DELETE: "budgets:archive" },
  job_budget_templates: { GET: "budgets:read", POST: "budgets:write", PATCH: "budgets:write", DELETE: "budgets:archive" },
  job_budget_template_items: { GET: "budgets:read", POST: "budgets:write", PATCH: "budgets:write", DELETE: "budgets:archive" },
  job_budget_history: { GET: "budgets:read", POST: "budgets:write", PATCH: "admin:manage", DELETE: "admin:manage" },
...
const FEATURE_BY_TABLE = {
  ...
  budget_settings: "job_budgeter_enabled",
  job_budgets: "job_budgeter_enabled",
  job_budget_labor: "job_budgeter_enabled",
  job_budget_materials: "job_budgeter_enabled",
  budget_material_catalog: "job_budgeter_enabled",
  job_budget_equipment: "job_budgeter_enabled",
  job_budget_costs: "job_budgeter_enabled",
  job_budget_change_orders: "job_budgeter_enabled",
  job_budget_documents: "job_budgeter_enabled",
  job_budget_templates: "job_budgeter_enabled",
  job_budget_template_items: "job_budgeter_enabled",
  job_budget_history: "job_budgeter_enabled",
