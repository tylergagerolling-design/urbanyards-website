...
function documentInsights({ snapshot, record }) {
  ...
  return {
    ...
    extractionCapability: "The Lawnmower Man can reason over stored document metadata and extracted text supplied by the dashboard; it does not invent unread file contents.",
