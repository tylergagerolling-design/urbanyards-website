(() => {
  ...
  const defaultMessages = [{
    role: "assistant",
    content: "Hi, I am the Urban Yards assistant. I can help with services, seasonal property care, and preparing details for Tyler Gage to review."
  }];
  ...
  function fallbackReply(message) {
    ...
    if (text.includes("quote") || text.includes("estimate") || text.includes("price") || text.includes("cost")) {
      return "I can help prepare quote details. Please include property type, general location, service needed, approximate size, desired timeline, and photos if available. Final pricing and scheduling require Tyler Gage to review the property and project details through the website contact form.";
    }
    ...
    if (text.includes("mulch") || text.includes("bed")) {
      return "For Portland-area properties, mulch and bed refreshes are often useful in spring or early fall. They help beds look clean, reduce weeds, and protect soil moisture. Tyler Gage can review the site before confirming scope or timing.";
    }
    ...
    if (text.includes("phone") || text.includes("email") || text.includes("contact")) {
      return "For direct contact, please use the website contact form so Tyler Gage can review the details in one place.";
    }
