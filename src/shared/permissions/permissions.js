...
const PERMISSIONS = Object.freeze({
  ...
  COST_REVIEW_VIEW: "budgets.view",
  COST_REVIEW_CREATE: "budgets.create",
  COST_REVIEW_EDIT: "budgets.edit",
  COST_REVIEW_APPROVE: "budgets.approve",
...
const ROLE_PERMISSIONS = Object.freeze({
  ...
  [ROLES.ACCOUNTANT]: [
    ...
    PERMISSIONS.COST_REVIEW_VIEW,
    PERMISSIONS.COST_REVIEW_CREATE,
    PERMISSIONS.COST_REVIEW_EDIT,
