...
const ROLE_PERMISSIONS = Object.freeze({
  ...
  [ROLES.MANAGER]: [
    ...
    PERMISSIONS.TICKETS_EDIT_SCHEDULE,
    ...
    PERMISSIONS.JOBS_EDIT_SCOPE,
    PERMISSIONS.JOBS_EDIT_SCHEDULE,
...
function normalizeRole(role) {
  ...
  if (value === "administrator") return ROLES.ADMIN;
  if (value === "sales") return ROLES.SALES_OUTREACH;
  if (value === "field" || value === "employee") return ROLES.FIELD_WORKER;
  if (value === "crew") return ROLES.WORKER;
  if (value === "accounting") return ROLES.ACCOUNTANT;
