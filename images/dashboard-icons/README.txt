...
Suggested mapping:
- home.svg -> Home
- work-briefcase.svg -> Work
- outreach-send.svg -> Outreach
- properties-building.svg -> Properties
- more-horizontal.svg -> More
- plus.svg -> New Job / Add
- log-time-clock.svg -> Log Time
- new-lead-user.svg -> New Lead
- add-property-building.svg -> Add Property
- settings-gear.svg -> Manage in Settings
...
CSS example:
.icon { width: 20px; height: 20px; color: #264b35; }
